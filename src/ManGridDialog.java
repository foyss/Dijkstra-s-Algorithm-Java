...
public class ManGridDialog extends JFrame {
     ...
     * Create the frame.
     */
    public ManGridDialog(int gridSize, int startNode, int endNode, HashMap<Integer, Integer> parentPath, double pathLength, HashMap<Integer, Integer> blockedPath) {
        ...
        JLabel lblEuclideanPath = new JLabel("Manhattan Path");
