...
public class CheGridDialog extends JFrame {
     ...
     * Create the frame.
     */
    public CheGridDialog(int gridSize, int startNode, int endNode, HashMap<Integer, Integer> parentPath, double pathLength, HashMap<Integer, Integer> blockedPath) {
        ...
        JLabel lblEuclideanPath = new JLabel("Chebyshev Path");
